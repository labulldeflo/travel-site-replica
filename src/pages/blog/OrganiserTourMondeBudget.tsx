...
const OrganiserTourMondeBudget = () => {
  return (
    <ArticleTemplate
      ...
      faqs={[
        { question: "Quel budget minimum pour un tour du monde ?", answer: "12 000 € pour 12 mois en mode backpacker (Asie du Sud-Est et Amérique latine majoritaires, dortoirs, street food, bus). Ajoutez 20 % de marge pour les imprévus, soit un budget cible réaliste de 15 000 €. En dessous de 10 000 €/an, il faut raccourcir à 6-8 mois ou travailler en route (WWOOF, woofing, jobs saisonniers)." },
        { question: "Combien coûte un billet tour du monde en 2026 ?", answer: "Entre 2 800 € (4 continents, classe éco, Star Alliance ou OneWorld) et 6 500 € (6 continents). Le billet TDM est intéressant si vous visitez 5+ continents avec dates flexibles. Pour 2-3 continents, les vols séparés via Skyscanner et Google Flights reviennent souvent 20-30 % moins cher." },
        { question: "Combien de temps faut-il pour préparer un tour du monde ?", answer: "Comptez 6 à 12 mois de préparation : 3-6 mois pour économiser et boucler le budget, 2-3 mois pour les démarches (visa, vaccins, assurance, billet d'avion, location de l'appartement), 1-2 mois pour l'équipement et la check-list finale. Un délai inférieur à 6 mois est faisable mais stressant." },
        { question: "Quel itinéraire choisir pour un tour du monde pas cher ?", answer: "L'itinéraire le plus économique combine Asie du Sud-Est (Vietnam, Laos, Cambodge, Thaïlande, Indonésie), Amérique latine (Pérou, Bolivie, Colombie, Mexique) et optionnellement l'Europe de l'Est. Évitez Japon, Australie, Nouvelle-Zélande et Islande si le budget est serré : ces destinations doublent le coût journalier." },
        { question: "Quelle assurance voyage choisir pour un tour du monde ?", answer: "Trois assurances spécialisées longue durée dominent le marché : Chapka Cap Aventure, Heymondo Long Stay et ACS Globe PVT. Comptez 600-900 € pour 12 mois, avec couverture médicale, rapatriement, bagages et responsabilité civile. Vérifiez le plafond médical (minimum 200 000 €) et la prise en charge des activités à risque (plongée, trek)." },
        { question: "Peut-on travailler pendant un tour du monde ?", answer: "Oui, plusieurs options existent : WWOOF (travail à la ferme contre logement et nourriture), Workaway et HelpX (échange travail-hébergement), jobs saisonniers en Australie / Nouvelle-Zélande avec PVT, télétravail freelance (digital nomad), ou cours de français / anglais à l'étranger. Cela peut prolonger un tour du monde de 50 à 100 %." },
        { question: "Quels documents faut-il pour un tour du monde ?", answer: "Passeport valable 6 mois après la date de retour avec 6 pages vierges minimum, e-visas anticipés pour les pays exigeants (Inde, Russie, Chine, Vietnam au-delà de 45 jours), carnet international de vaccination (fièvre jaune obligatoire pour certains pays), permis de conduire international, carte d'étudiant ISIC, et copies cloud de tous les documents." },
        { question: "Comment financer un tour du monde quand on n'a pas d'argent ?", answer: "Trois leviers principaux : 1) épargner 600-800 €/mois pendant 18-24 mois en réduisant logement et sorties, 2) sous-louer ou vendre voiture/biens avant le départ, 3) combiner travail en route (WWOOF, jobs saisonniers, freelance) pour prolonger sans entamer les économies. Évitez les crédits voyage : taux prohibitifs et stress au retour." },
      ]}
      contentSections={[
        {
          icon: DollarSign,
