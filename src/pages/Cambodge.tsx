    ...
    <>
      ...
      <main className="pt-24">
        ...
        <section className="py-12 bg-ocean/5">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-2xl font-elegant font-bold mb-6 text-center">📚 Articles pour préparer votre voyage au Cambodge</h2>
        ...
        <section className="py-8">
          <div className="container mx-auto px-4 max-w-4xl">
            <OrganiserVoyageBlock destination="Cambodge" showEsim showAssurance />
          </div>
        </section>
