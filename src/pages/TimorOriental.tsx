                    ...
                    <Card key={dest.slug} className="group hover:shadow-elegant transition-all duration-300">
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          ...
                          <Button 
                            className="w-full" 
                            onClick={() => window.location.href = `/destinations/timor-oriental/${dest.slug}`}
                          >
                            Lire l'article
                          </Button>
                        </div>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          ...
                          <Button 
                            ...
                            onClick={() => window.location.href = `/destinations/timor-oriental/itineraire-${itinerary.duration.replace(' ', '-')}`}
                          >
